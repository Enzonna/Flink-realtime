package com.enzo.gmall.realtime.dwd.app;
...
/**
 * zk.kafka.maxwell.DwdTradeOrderCancelDetail.DwdTradeCartAdd
 */
public class DwdTradeOrderCancelDetail extends BaseSQLApp {
    ...
    public void handle(StreamExecutionEnvironment env, StreamTableEnvironment tEnv) {
        tEnv.getConfig().setIdleStateRetention(Duration.ofSeconds(15 * 60 + 10));
        // 1. 读取 topic_db 数据
        ...
        tEnv.executeSql(
                "create table " + Constant.TOPIC_DWD_TRADE_ORDER_CANCEL + " (" +
                        ...
                        ")" + SQLUtil.getUpsertKafka(Constant.TOPIC_DWD_TRADE_ORDER_CANCEL));
